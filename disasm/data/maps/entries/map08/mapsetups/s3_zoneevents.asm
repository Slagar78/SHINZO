...
Map8_ZoneEvent0:
                ...
                chkFlg  708             ; Set after the scene in Ribble where the mayor confronts MUSHRA
                bne.s   return_561D8
                chkFlg  258             ; TEMP FLAG #02
                bne.s   return_561D8
                script  cs_563B2
                setFlg  703             ; Set after the scene where MUSHRA brings the plank above deck, also set after the initial Ribble scene, where the guy runs away
...
Map8_ZoneEvent2:
                ...
                script  cs_56422
                setFlg  708             ; Set after the scene in Ribble where the mayor confronts MUSHRA
