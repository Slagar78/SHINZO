...
cs_5CBB4:       textCursor 4179
                ...
                csc_end
cs_5CC26:       entityFlashWhite ALLY_MUSHRA,50
                setActscript ALLY_MUSHRA,eas_RotateRightHighSpeed
                csWait 30
                ...
                executeSubroutine FadeInFromWhite
                csWait 30
                entityFlashWhite ALLY_MUSHRA,50
                setActscriptWait ALLY_MUSHRA,eas_Init
                startEntity ALLY_MUSHRA
                csc_end
cs_5CCF6:       entityFlashWhite ALLY_MUSHRA,50
                setActscript ALLY_MUSHRA,eas_RotateRightHighSpeed
                csWait 30
                executeSubroutine FadeOutToWhite
                mapLoad MAP_MAGIC_TUNNEL_PIPE,0,0
