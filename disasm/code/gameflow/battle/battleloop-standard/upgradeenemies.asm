...
@Continue:
                ...
                move.b  (a1),d1
                sub.w   d1,d2
                ble.s   @DefaultEnemy   ; default to original enemy if MUSHRA's effective level is lower than or equal
                ...
                andi.l  #BYTE_MASK,d2
                tst.w   d2
                beq.s   @DefaultEnemy   ; default to original enemy if MUSHRA is less than 10 levels over current battle
