...
OTHER_ENTITIES_DATA: equ ENTITY_DATA+NEXT_ENTITYDEF ; Start of entities after first one (MUSHRA)
...
PLAYER_TYPE:                equ savedDataStart+SAVED_DATA_OFFSET_PLAYER_TYPE ; holds which player entity type we are (00=MUSHRA, 01=caravan, 02=raft)
